...
This folder contains all the project documentation files. Here's what each file covers:
...
- **[DEBUG_SETUP.md](./DEBUG_SETUP.md)** - Development debugging setup and tools

### **Deployment & Production**
- **[PRODUCTION_DEPLOYMENT.md](./PRODUCTION_DEPLOYMENT.md)** - Production deployment guide and best practices

### **Technical Comparisons**
- **[SCANNER_COMPARISON.md](./SCANNER_COMPARISON.md)** - Comparison of barcode vs QR code scanning systems

## 📖 Quick Navigation

### For Developers
1. Start with [PROJECT_STRUCTURE.md](./PROJECT_STRUCTURE.md) to understand the codebase
2. Follow [ENVIRONMENT_SETUP.md](./ENVIRONMENT_SETUP.md) to configure your development environment
3. Use [DEBUG_SETUP.md](./DEBUG_SETUP.md) for debugging tools and techniques

### For Deployment
1. Read [PRODUCTION_DEPLOYMENT.md](./PRODUCTION_DEPLOYMENT.md) for deployment instructions
2. Ensure [ENVIRONMENT_SETUP.md](./ENVIRONMENT_SETUP.md) is properly configured for production
...
Here's the complete list of documentation files in this folder:
...
| [SCANNER_COMPARISON.md](./SCANNER_COMPARISON.md) | Barcode vs QR system comparison | Technical Analysis |
...
Return to the main [README.md](../README.md) for project overview and getting started guide.
